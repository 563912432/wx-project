  ...
  <div class="exam">
    ...
    <div class="control-tools" v-if="exam">
      ...
      <span @click="doCollect">
        ...
        收藏</span>
      <span @click="remove"><i class="icon iconfont icon-trash"></i>移出错题</span>
    </div>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    computed: {
      ...
      exam_index () {
        return this.$store.state.examState.curr_index || 0
      }
    },
    ...
    methods: {
      ...
      remove () {
        ...
        this.$store.dispatch('removeErrorExam', data)
      },
      getPaperOfError () {
        Indicator.open('载入中...')
        let that = this
        ...
        this.$store.dispatch('getPaperOfError', data)
      },
      card () {
